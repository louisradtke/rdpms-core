...
class CollectionsApi:
    ...
    def api_v1_data_collections_get(
        ...
        _param = self._api_v1_data_collections_get_serialize(
    ...
    def api_v1_data_collections_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CollectionSummaryDTO]]:
        """Get all collections.
    ...
    def _api_v1_data_collections_get_serialize(
        self,
        project_id,
        project_slug,
        slug,
        ...
        if project_slug is not None:
            ...
            _query_params.append(('projectSlug', project_slug))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/data/collections',
    ...
    def api_v1_data_collections_id_get(
        ...
        _param = self._api_v1_data_collections_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v1_data_collections_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_delete(
        self,
        id: UUID,
        key: StrictStr,
        ...
        """api_v1_data_collections_id_metadata_key_delete
        ...
        _param = self._api_v1_data_collections_id_metadata_key_delete_serialize(
            id=id,
            key=key,
            target=target,
            _request_auth=_request_auth,
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_delete_with_http_info(
        self,
        id: UUID,
        key: StrictStr,
        target: Optional[MetadataColumnTarget] = None,
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_delete_without_preload_content(
        self,
        id: UUID,
        key: StrictStr,
        target: Optional[MetadataColumnTarget] = None,
    ...
    def _api_v1_data_collections_id_metadata_key_delete_serialize(
        self,
        id,
        key,
        target,
        ...
        if target is not None:
            ...
            _query_params.append(('target', target.value))
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_post(
        self,
        id: UUID,
        key: StrictStr,
        ...
        """api_v1_data_collections_id_metadata_key_post
        ...
        _param = self._api_v1_data_collections_id_metadata_key_post_serialize(
            id=id,
            key=key,
            new_key=new_key,
            target=target,
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_post_with_http_info(
        self,
        id: UUID,
        key: StrictStr,
        new_key: Optional[StrictStr] = None,
    ...
    @validate_call
    def api_v1_data_collections_id_metadata_key_post_without_preload_content(
        self,
        id: UUID,
        key: StrictStr,
        new_key: Optional[StrictStr] = None,
    ...
    def _api_v1_data_collections_id_metadata_key_post_serialize(
        self,
        id,
        key,
        new_key,
    ...
    @validate_call
    def api_v1_data_collections_post(
        self,
        collection_summary_dto: Optional[CollectionSummaryDTO] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param collection_summary_dto: 
        :type collection_summary_dto: CollectionSummaryDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._api_v1_data_collections_post_serialize(
            collection_summary_dto=collection_summary_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def api_v1_data_collections_post_with_http_info(
        self,
        collection_summary_dto: Optional[CollectionSummaryDTO] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_data_collections_post_without_preload_content(
        self,
        collection_summary_dto: Optional[CollectionSummaryDTO] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_data_collections_post_serialize(
        self,
        collection_summary_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if collection_summary_dto is not None:
            _body_params = collection_summary_dto
