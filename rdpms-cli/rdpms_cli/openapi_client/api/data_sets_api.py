...
class DataSetsApi:
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_delete(
        self,
        id: Annotated[UUID, Field(description="ID of the dataset.")],
        ...
        _param = self._api_v1_data_datasets_id_metadata_key_delete_serialize(
            id=id,
            key=key,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_delete_with_http_info(
        self,
        id: Annotated[UUID, Field(description="ID of the dataset.")],
        key: Annotated[StrictStr, Field(description="Key to remove the relation for")],
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_delete_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="ID of the dataset.")],
        key: Annotated[StrictStr, Field(description="Key to remove the relation for")],
        _request_timeout: Union[
    ...
    def _api_v1_data_datasets_id_metadata_key_delete_serialize(
        self,
        id,
        key,
        _request_auth,
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_post(
        self,
        id: Annotated[UUID, Field(description="The dataset ID.")],
        ...
        _param = self._api_v1_data_datasets_id_metadata_key_post_serialize(
            id=id,
            key=key,
            new_key=new_key,
            _request_auth=_request_auth,
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_post_with_http_info(
        self,
        id: Annotated[UUID, Field(description="The dataset ID.")],
        key: Annotated[StrictStr, Field(description="The old key.")],
        new_key: Annotated[Optional[StrictStr], Field(description="The new key.")] = None,
    ...
    @validate_call
    def api_v1_data_datasets_id_metadata_key_post_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="The dataset ID.")],
        key: Annotated[StrictStr, Field(description="The old key.")],
        new_key: Annotated[Optional[StrictStr], Field(description="The new key.")] = None,
    ...
    def _api_v1_data_datasets_id_metadata_key_post_serialize(
        self,
        id,
        key,
        new_key,
    ...
    @validate_call
    def api_v1_data_datasets_new_sealed_s3_post(
        self,
        sealed_s3_data_set_create_request_dto: Annotated[Optional[SealedS3DataSetCreateRequestDTO], Field(description="Dataset and file references to register.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param sealed_s3_data_set_create_request_dto: Dataset and file references to register.
        :type sealed_s3_data_set_create_request_dto: SealedS3DataSetCreateRequestDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._api_v1_data_datasets_new_sealed_s3_post_serialize(
            sealed_s3_data_set_create_request_dto=sealed_s3_data_set_create_request_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def api_v1_data_datasets_new_sealed_s3_post_with_http_info(
        self,
        sealed_s3_data_set_create_request_dto: Annotated[Optional[SealedS3DataSetCreateRequestDTO], Field(description="Dataset and file references to register.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_data_datasets_new_sealed_s3_post_without_preload_content(
        self,
        sealed_s3_data_set_create_request_dto: Annotated[Optional[SealedS3DataSetCreateRequestDTO], Field(description="Dataset and file references to register.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_data_datasets_new_sealed_s3_post_serialize(
        self,
        sealed_s3_data_set_create_request_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if sealed_s3_data_set_create_request_dto is not None:
            _body_params = sealed_s3_data_set_create_request_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/data/datasets/new/sealed/s3',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
