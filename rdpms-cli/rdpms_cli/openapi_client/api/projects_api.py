...
class ProjectsApi:
    ...
    def api_v1_projects_get(
        ...
        _param = self._api_v1_projects_get_serialize(
            slug=slug,
    ...
    @validate_call
    def api_v1_projects_get_with_http_info(
        self,
        slug: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectSummaryDTO]]:
        """Get all projects.
    ...
    @validate_call
    def api_v1_projects_get_without_preload_content(
        self,
        slug: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_projects_get_serialize(
        self,
        slug,
        _request_auth,
        _content_type,
    ...
    def api_v1_projects_id_get(
        ...
        _param = self._api_v1_projects_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _api_v1_projects_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def api_v1_projects_id_put(
        ...
        _param = self._api_v1_projects_id_put_serialize(
            id=id,
            project_summary_dto=project_summary_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _api_v1_projects_id_put_serialize(
        self,
        id,
        project_summary_dto,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if project_summary_dto is not None:
            _body_params = project_summary_dto
