...
class MetadataQueryPartDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["query", "metadataKey", "target"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetadataQueryPartDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetadataQueryPartDTO from a dict"""
        if obj is None:
            return None
