<main class="m-5">
    <h1 class="text-2xl font-bold my-4">Welcome RDPMS</h1>

    RDPMS stands for Research Data and Pipeline Management System.

    <h2 class="text-xl font-bold my-4">Index</h2>
