...
<div class="flex h-full min-w-0">
    <Sidebar itemsPromise={collectionsSidebarListPromise} baseUrl="/projects/{projectSlug}/c/*" />

    <div class="flex min-w-0 flex-1 flex-col">
        <main class="m-5 min-w-0 flex-1 overflow-y-auto p-4">
            {#await collectionReq}
                <LoadingCircle />
            {:then collection}
            ...
            <h2 class="text-2xl font-bold my-4">Contained datasets:</h2>
